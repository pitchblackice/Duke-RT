...
cmake -G Ninja -S "%REPO_ROOT%" -B "%RAZE_BUILD%" -DCMAKE_BUILD_TYPE=Release -DCMAKE_TOOLCHAIN_FILE="%TOOLCHAIN_FILE%" -DVCPKG_INSTALLED_DIR="%VCPKG_INSTALLED_DIR%" -DVCPKG_OVERLAY_PORTS="%VCPKG_OVERLAY_PORTS%" -DZMUSIC_INCLUDE_DIR="%ZMUSIC_INCLUDE_DIR%" -DZMUSIC_LIBRARIES="%ZMUSIC_LIBRARIES%"
if errorlevel 1 exit /b %errorlevel%
