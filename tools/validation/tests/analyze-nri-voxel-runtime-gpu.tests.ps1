...
PERF pt trace workload NRI: frame=1001 nri_frame=1001 renderer_frame=101 compact=1 epoch=7 sample=0
PERF pt trace workload NRI: frame=1002 nri_frame=1002 renderer_frame=102 compact=1 epoch=7 sample=1
PERF pt trace workload NRI: frame=1003 nri_frame=1003 renderer_frame=103 compact=1 epoch=7 sample=2
PERF pt trace workload NRI: frame=1004 nri_frame=1004 renderer_frame=104 compact=1 epoch=7 sample=3
PERF pt gpu timing NRI: frame=1001 nri_frame=1001 segment=10.000 scene=9.000 trace=8.000 trace_dispatch=7.000 denoise=1.000 compose=1.000 upscale=0.000 final=0.000 segments=1 invalid=0 dropped=0 resolved=1 expected=1 compact=1 epoch=7 sample=0
PERF pt gpu timing NRI: frame=1002 nri_frame=1002 segment=17.000 scene=16.000 trace=12.000 trace_dispatch=11.000 denoise=2.000 compose=1.000 upscale=0.000 final=0.000 segments=1 invalid=0 dropped=0 resolved=1 expected=1 compact=1 epoch=7 sample=1
PERF pt gpu timing NRI: frame=1003 nri_frame=1003 segment=20.000 scene=19.000 trace=13.000 trace_dispatch=12.000 denoise=3.000 compose=1.000 upscale=0.000 final=0.000 segments=1 invalid=0 dropped=0 resolved=1 expected=1 compact=1 epoch=7 sample=2
PERF pt gpu timing NRI: frame=1004 nri_frame=1004 segment=12.000 scene=11.000 trace=9.000 trace_dispatch=8.000 denoise=1.000 compose=1.000 upscale=0.000 final=0.000 segments=1 invalid=0 dropped=0 resolved=1 expected=1 compact=1 epoch=7 sample=3
PERF pt voxel gpu timing NRI: renderer_frame=1000 presentation_gen=10 queued_slot=0 segment=10.000000 segment_valid=1 admission=0.000000 upload=0.000000 arena_copy=0.000000 classify=0.000000 scan=0.000000 emit=0.000000 finalize=0.000000 voxel_blas=0.000000 world_tlas=0.300000 scopes=1 valid=1 invalid=0 dropped=0 compact=1 epoch=7 record=0
PERF pt voxel gpu timing NRI: renderer_frame=1001 presentation_gen=11 queued_slot=1 segment=17.000000 segment_valid=1 admission=1.000000 upload=0.200000 arena_copy=0.000000 classify=0.400000 scan=0.100000 emit=0.600000 finalize=0.050000 voxel_blas=0.000000 world_tlas=0.300000 scopes=7 valid=7 invalid=0 dropped=0 compact=1 epoch=7 record=1
PERF pt voxel gpu timing NRI: renderer_frame=1002 presentation_gen=12 queued_slot=2 segment=20.000000 segment_valid=1 admission=3.000000 upload=0.000000 arena_copy=0.000000 classify=2.000000 scan=0.500000 emit=2.500000 finalize=0.200000 voxel_blas=1.200000 world_tlas=0.300000 scopes=7 valid=7 invalid=0 dropped=0 compact=1 epoch=7 record=2
PERF pt voxel gpu timing NRI: renderer_frame=1003 presentation_gen=13 queued_slot=0 segment=12.000000 segment_valid=1 admission=0.000000 upload=0.000000 arena_copy=0.000000 classify=0.000000 scan=0.000000 emit=0.000000 finalize=0.000000 voxel_blas=0.000000 world_tlas=0.300000 scopes=1 valid=1 invalid=0 dropped=0 compact=1 epoch=7 record=3
...
try {
    ...
    if ($summary.runtimeTailCorrelation.uniqueEventFrames -ne 2 -or
        ...
        $summary.runtimeTailCorrelation.completeGpuTargetMissesOnMatchedFrames -ne 1) {
        throw 'Runtime-tail renderer-frame correlation is incorrect.'
    }
    if ($summary.runtimeTailCorrelation.frameBridge -notmatch 'trace-workload\.renderer_frame' -or
        $summary.runtimeTailCorrelation.workloadRows -ne 4) {
        throw 'Runtime-tail correlation did not report its cross-domain workload bridge.'
    }
    ...
    $invalidBridgePath = Join-Path $tempRoot 'invalid-bridge.log'
    $invalidBridgeSummary = Join-Path $tempRoot 'invalid-bridge.json'
    $invalidBridgeLog = $validLog.Replace(
        'frame=1002 nri_frame=1002 renderer_frame=102 compact=1 epoch=7 sample=1',
        'frame=1002 nri_frame=1002 renderer_frame=999 compact=1 epoch=7 sample=1')
    [System.IO.File]::WriteAllText($invalidBridgePath, $invalidBridgeLog)
    & powershell.exe -NoProfile -ExecutionPolicy Bypass -File $analyzer -LogPath $invalidBridgePath -SummaryOutput $invalidBridgeSummary | Out-Null
    if ($LASTEXITCODE -eq 0) { throw 'Broken runtime/workload frame bridge fixture passed.' }
    $invalidBridge = Get-Content -LiteralPath $invalidBridgeSummary -Raw | ConvertFrom-Json
    if ($invalidBridge.ok -or $invalidBridge.runtimeTailCorrelation.unmatchedEventFrames -ne 1 -or
        @($invalidBridge.errors | Where-Object { $_ -match 'frame bridge matched 1/2' }).Count -ne 1) {
        throw 'Broken runtime/workload frame bridge was not reported precisely.'
    }
}
finally {
