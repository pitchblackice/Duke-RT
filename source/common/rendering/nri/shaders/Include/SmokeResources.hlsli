...
#define NRI_SMOKE_DIRECTIONAL_PROBE_AXIS 5u
#define NRI_SMOKE_DIRECTIONAL_PROBE_RADIUS 2
#define NRI_SMOKE_DIRECTIONAL_PROBES_PER_PARTICLE 125u
#define NRI_SMOKE_DIRECTIONAL_PROBE_CELL_SIZE 8.0
