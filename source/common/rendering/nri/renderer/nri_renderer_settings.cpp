...
NRISmokeSettings BuildNRISmokeSettingsFromCVars()
{
	...
	const int emissiveReferenceSamples = (int)nri_ptsmokeemissivereferencesamples;
	settings.emissiveReferenceSamples = emissiveReferenceSamples <= 32 ? 32u :
		(emissiveReferenceSamples <= 256 ? 256u : 512u);
