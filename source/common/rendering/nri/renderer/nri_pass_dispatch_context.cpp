...
NRIPassDispatchContext::NRIPassDispatchContext(const Init& init)
	...
	mFrameIndex(mFrame.frameIndex),
	mRenderWidth(mFrame.renderWidth),
	mRenderHeight(mFrame.renderHeight),
	mOutputWidth(mFrame.outputWidth),
	mOutputHeight(mFrame.outputHeight),
	mTargetWidth(mFrame.targetWidth),
	mTargetHeight(mFrame.targetHeight),
	mSceneLeft(mFrame.sceneLeft),
	mSceneTop(mFrame.sceneTop),
	mCurrentCameraPos(mFrame.currentCameraPos.data()),
	mCurrentCameraForward(mFrame.currentCameraForward.data()),
	mCurrentCameraRight(mFrame.currentCameraRight.data()),
	mCurrentCameraUp(mFrame.currentCameraUp.data()),
	mPreviousCameraPos(mFrame.previousCameraPos.data()),
	mPreviousCameraForward(mFrame.previousCameraForward.data()),
	mPreviousCameraRight(mFrame.previousCameraRight.data()),
	mPreviousCameraUp(mFrame.previousCameraUp.data()),
	mCurrentTanHalfFovX(mFrame.currentTanHalfFovX),
	mCurrentTanHalfFovY(mFrame.currentTanHalfFovY),
	mPreviousTanHalfFovX(mFrame.previousTanHalfFovX),
	mPreviousTanHalfFovY(mFrame.previousTanHalfFovY),
	mCurrentJitter(mFrame.currentJitter.data()),
	mPreviousJitter(mFrame.previousJitter.data()),
	mCurrentViewToClip(mFrame.currentViewToClip.data()),
	mPreviousViewToClip(mFrame.previousViewToClip.data()),
	mCurrentWorldToView(mFrame.currentWorldToView.data()),
	mPreviousWorldToView(mFrame.previousWorldToView.data()),
	mSkyColor(mFrame.skyColor.data()),
	mGroundColor(mFrame.groundColor.data()),
	mGuiCaptureActive(mFrame.guiCaptureActive),
	mResetHistory(mFrame.resetHistory),
	...
	mSceneInstanceCount(mSceneStats.sceneInstanceCount),
	mBoundStaticPrimitiveCount(mSceneStats.staticPrimitiveCount),
	mBoundDynamicPrimitiveCount(mSceneStats.dynamicPrimitiveCount),
	mBoundStaticMaterialCount(mSceneStats.staticMaterialCount),
	mBoundDynamicMaterialCount(mSceneStats.dynamicMaterialCount),
	mBoundPortalCount(mSceneStats.portalCount),
	mBoundRuntimeLightCount(mSceneStats.runtimeLightCount),
	mBoundRuntimeLightTileCountX(mSceneStats.runtimeLightTileCountX),
	mBoundRuntimeLightTileCountY(mSceneStats.runtimeLightTileCountY),
