...
CVAR(Int, nri_ptsmokequality, 1, CVAR_ARCHIVE | CVAR_GLOBALCONFIG)
...
CVAR(Float, nri_ptsmokewindx, 0.0f, CVAR_ARCHIVE | CVAR_GLOBALCONFIG)
CVAR(Float, nri_ptsmokewindy, 0.0f, CVAR_ARCHIVE | CVAR_GLOBALCONFIG)
CVAR(Float, nri_ptsmokewindz, 0.0f, CVAR_ARCHIVE | CVAR_GLOBALCONFIG)
CVAR(Float, nri_ptsmokedensityscale, 1.0f, CVAR_ARCHIVE | CVAR_GLOBALCONFIG)
...
CVAR(Int, nri_ptsmokeemissivereuse, 2, CVAR_ARCHIVE | CVAR_GLOBALCONFIG)
CVAR(Bool, nri_ptsmokeemissivereference, false, 0)
CVAR(Int, nri_ptsmokeemissivereferencesamples, 32, 0)
...
CVAR(Int, nri_ptsmokerepresentation, 0, CVAR_ARCHIVE | CVAR_GLOBALCONFIG)
